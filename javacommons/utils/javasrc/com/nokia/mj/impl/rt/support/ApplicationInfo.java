...
public abstract class ApplicationInfo
{
    ...
    /**
     * A constant representing the JavaInstaller runtime when
     * returned from the method {@link ApplicationInfo#getRuntimeType
     * getRuntimeType}
     */
    public static final String RUNTIME_INSTALLER = "INSTALLER";
     ...
     * <p>
     * @return the suite Uid if available, otherwise null.
     */
     ...
     *
     *
     * @return Suite name as String if available, otherwise null.
     */
     ...
     *
     * @return application name as String if available, otherwise null.
     */
    ...
    /**
     * Returns the localized name of the application. Some runtime implmentations
     * might not return the value at all.
     * <p>
     * In MIDP this method returns the localized name of the MIDlet,
     * i.e. the value of Nokia-MIDlet-<n>-<locale>, for example
     * Nokia-MIDlet-Name-es-MX: HolaMundo
     *
     * @return localized application name as String if available, otherwise null.
     */
     ...
     * might not return the value at all.
     *
     * @return application vendor as String if available, otherwise null.
     */
     ...
     * @return application version as String if available, otherwise null.
     */
