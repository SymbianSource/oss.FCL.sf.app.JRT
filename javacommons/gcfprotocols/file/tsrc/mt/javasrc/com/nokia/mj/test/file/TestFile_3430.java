...
public class TestFile_3430 extends FileTestBase
{
    public TestFile_3430()
    {
    }

    public TestFile_3430(String aTestName, TestMethod aTestMethod)
    {
    ...
    {
        suite.addTest(new TestFile_3430("run_3430", new TestMethod()
        {
            public void run(TestCase tc)
            {
                ((TestFile_3430) tc).run_3430();
            }
        }));
    }
    ...
    public void run_3430()
    {
        ...
        try
        {
            ...
            // This is same test as test run_3420() except 10 bytes has been
            // read
            ...
            assertTrue(" run_3430() ok ", true);
        }
        catch (Exception ex)
        {
            append(ex.toString());
            append("TEST FAILED!!! Case: run_3430() counter: " + counter + "\n");
            assertTrue(" run_3430() FAILED!!! Counter: " + counter, false);
        }
    }//end run_3430()
