...
public class HttpsProtocolPermissionImpl
        extends PermissionBase
{
    private HttpsProtocolPermission iHelper;
    private SecurityPromptMessage pm = SecurityPromptMessage.getInstance();
    private String promptText;

    public HttpsProtocolPermissionImpl(String uri)
    {
        this(uri, null);
    }

    public HttpsProtocolPermissionImpl(String uri, String promptText)
    {
        super(uri);
        iHelper = new HttpsProtocolPermission(uri);
        this.promptText = promptText;
    }

    public boolean implies(Permission p)
    {
        if (p instanceof HttpsProtocolPermissionImpl)
        {
            return true;
        }
    ...
    {
        return "(HttpsProtocolPermission" + " " + getName() + " " + getActions() + ")";
    }
}
