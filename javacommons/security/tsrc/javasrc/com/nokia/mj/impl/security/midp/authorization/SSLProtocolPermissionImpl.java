...
public class SSLProtocolPermissionImpl
        extends PermissionBase
{
    private SSLProtocolPermission iHelper;
    private SecurityPromptMessage pm = SecurityPromptMessage.getInstance();
    private String promptText;

    public SSLProtocolPermissionImpl(String uri)
    {
        this(uri, null);
    }

    public SSLProtocolPermissionImpl(String uri, String promptText)
    {
        super(uri);
        iHelper = new SSLProtocolPermission(uri);
        this.promptText = promptText;
    }

    public boolean implies(Permission p)
    {
        if (p instanceof SSLProtocolPermissionImpl)
        {
            return true;
        }
    ...
    {
        return "(SSLProtocolPermission" + " " + getName() + " " + getActions() + ")";
    }
