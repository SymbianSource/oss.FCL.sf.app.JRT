...
public class SocketProtocolPermissionImpl
        extends PermissionBase
{
    private SocketProtocolPermission iHelper;
    private SecurityPromptMessage pm = SecurityPromptMessage.getInstance();
    private String promptText;

    public SocketProtocolPermissionImpl(String uri)
    {
        this(uri, null);
    }

    public SocketProtocolPermissionImpl(String uri, String promptText)
    {
        super(uri);
        iHelper = new SocketProtocolPermission(uri);
        this.promptText = promptText;
    }

    public boolean implies(Permission p)
    {
        if (p instanceof SocketProtocolPermissionImpl)
        {
            return true;
        }
    ...
    {
        return "(SocketProtocolPermission" + " " + getName() + " " + getActions() + ")";
    }
