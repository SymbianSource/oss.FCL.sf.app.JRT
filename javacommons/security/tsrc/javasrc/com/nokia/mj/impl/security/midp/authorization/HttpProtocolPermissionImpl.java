...
public class HttpProtocolPermissionImpl
        extends PermissionBase
{
    private HttpProtocolPermission iHelper;
    private SecurityPromptMessage pm = SecurityPromptMessage.getInstance();
    private String promptText;

    public HttpProtocolPermissionImpl(String uri)
    {
        this(uri, null);
    }

    public HttpProtocolPermissionImpl(String uri, String promptText)
    {
        super(uri);
        iHelper = new HttpProtocolPermission(uri);
        this.promptText = promptText;
    }

    public boolean implies(Permission p)
    {
        if (p instanceof HttpProtocolPermissionImpl)
        {
            return true;
        }
    ...
    {
        return "(HttpProtocolPermission" + " " + getName() + " " + getActions() + ")";
    }
}
