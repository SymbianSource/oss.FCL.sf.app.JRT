...
/**
 * Timer tests adapted to Java ME from Apache Harmony (Open Source Java SE)
 * Main changes:
 *  - junit to j2meunit related changes
 *  - signature related changes (API on Java 1.3 level)
 */
...
public class TimerTest extends TestCase
{
    ...
    public TimerTest(String sTestName, TestMethod rTestMethod)
    {
    ...
    public Test suite()
    {
        ...
        aSuite.addTest(new TimerTest("test_ConstructorZ", new TestMethod()
        {
            public void run(TestCase tc)
            {
                ((TimerTest) tc).test_ConstructorZ();
            }
        }));

        aSuite.addTest(new TimerTest("test_Constructor", new TestMethod()
        {
            public void run(TestCase tc)
            {
                ((TimerTest) tc).test_Constructor();
            }
        }));

        aSuite.addTest(new TimerTest("test_ConstructorSZ", new TestMethod()
        {
            public void run(TestCase tc)
            {
                ((TimerTest) tc).test_ConstructorSZ();
            }
        }));

        aSuite.addTest(new TimerTest("test_ConstructorS", new TestMethod()
        {
            public void run(TestCase tc)
            {
                ((TimerTest) tc).test_ConstructorS();
            }
        }));

        aSuite.addTest(new TimerTest("test_cancel", new TestMethod()
        {
            public void run(TestCase tc)
            {
                ((TimerTest) tc).test_cancel();
            }
        }));

        aSuite.addTest(new TimerTest("test_purge()", new TestMethod()
        {
            public void run(TestCase tc)
            {
                ((TimerTest) tc).test_purge();
            }
        }));

        aSuite.addTest(new TimerTest("test_scheduleLjava_util_TimerTaskLjava_util_Date", new TestMethod()
        {
            public void run(TestCase tc)
            {
                ((TimerTest) tc).test_scheduleLjava_util_TimerTaskLjava_util_Date();
            }
        }));

        aSuite.addTest(new TimerTest("test_scheduleLjava_util_TimerTaskJ", new TestMethod()
        {
            public void run(TestCase tc)
            {
                ((TimerTest) tc).test_scheduleLjava_util_TimerTaskJ();
            }
        }));

        aSuite.addTest(new TimerTest("test_scheduleLjava_util_TimerTaskJJ", new TestMethod()
        {
            public void run(TestCase tc)
            {
                ((TimerTest) tc).test_scheduleLjava_util_TimerTaskJJ();
            }
        }));

        aSuite.addTest(new TimerTest("test_scheduleLjava_util_TimerTaskLjava_util_DateJ", new TestMethod()
        {
            public void run(TestCase tc)
            {
                ((TimerTest) tc).test_scheduleLjava_util_TimerTaskLjava_util_DateJ();
            }
        }));

        aSuite.addTest(new TimerTest("test_scheduleAtFixedRateLjava_util_TimerTaskJJ", new TestMethod()
        {
            public void run(TestCase tc)
            {
                ((TimerTest) tc).test_scheduleAtFixedRateLjava_util_TimerTaskJJ();
            }
        }));

        aSuite.addTest(new TimerTest("test_scheduleAtFixedRateLjava_util_TimerTaskLjava_util_DateJ", new TestMethod()
        {
            public void run(TestCase tc)
            {
                ((TimerTest) tc).test_scheduleAtFixedRateLjava_util_TimerTaskLjava_util_DateJ();
            }
        }));

        aSuite.addTest(new TimerTest("test_noCancel", new TestMethod()
        {
            public void run(TestCase tc)
            {
                ((TimerTest) tc).test_noCancel();
            }
        }));
...
//    public void test_purge() throws Exception {
    ...
    /**
     * @tests timer that is not cancelled
     */
    public void test_noCancel()
    {
        Timer t = new Timer();
        TimerTestTask testTask = new TimerTestTask();
        t.schedule(testTask, 1000*60*2); // 2min
    }
