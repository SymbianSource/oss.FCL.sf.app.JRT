...
public class TckRunnerException extends RuntimeException
{
     ...
     */
    public TckRunnerException(String aMsg)
    {
        super(aMsg);
    }
     ...
     */
    public TckRunnerException(String aMsg, Throwable aRootException)
    {
        super(aMsg);
