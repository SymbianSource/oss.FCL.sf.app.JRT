...
public class TestPlugin implements InstallerExtension
{
    ...
    {
        aInstallerExtensionInfo.log("TestPlugin.install called");
        return true;
    }
    ...
    {
        aInstallerExtensionInfo.log("TestPlugin.uninstall called");
        return true;
    }
    ...
    {
        aInstallerExtensionInfo.log("TestPlugin.rollbackInstall called");
    }
    ...
    {
        aInstallerExtensionInfo.log("TestPlugin.rollbackUninstall called");
    }
}
