 ...
 * CbsConnection object.
 */
public class Connection extends J9GcfConnectionBase
{
    private static Protocol iCbsProtocol = null;
    ...
    {
        if (iCbsProtocol == null)
        {
            iCbsProtocol = new Protocol();
        }
        return iCbsProtocol.openConnection(aName, aMode, aTimeouts);
    }
}