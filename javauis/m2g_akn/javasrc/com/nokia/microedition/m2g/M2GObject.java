 ...
 * Base class
 */
abstract class M2GObject implements M2GDestroyable
{
    //--------------------------------------------------
    // STATIC CONSTANTS
    //--------------------------------------------------
    ...
    boolean iUIToolkit              = LCDUI_TOOLKIT; // LCDUI is the current UITOOLKIT
    boolean iIsToolkitAvailable     = false; // LCDUI is the current UITOOLKIT
    ...
    {
        // Get the value of current UITOOLKIT.
        ...
        iManager = M2GManager.getInstance(iUIToolkit);
    }
    ...
    /**
    * Gets UiToolkit value
    * @return iUiTookit value
    */
    boolean getUiToolkit()
    {
        return iUIToolkit;
    }

    /**
     * Gets native event source handle
     * @return native event source handle
     */
    int getNativeEventSourceHandle()
    {
        return iManager.getEventSourceHandle();
    }
