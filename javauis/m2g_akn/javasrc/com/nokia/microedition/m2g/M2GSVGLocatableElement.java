        ...
        implements SVGLocatableElement
{
    ...
    public SVGRect getBBox()
    {
        ...
        M2GSVGElement._getBBox(
            getNativeEventSourceHandle(), getNativeSVGProxyHandle(), getHandle(),
            M2GSVGConstants.AT_BBOX, bbox.getComponents(), iUIToolkit);
    ...
    public SVGMatrix getScreenCTM()
    {
        if (getDocument().isElementInDOM(getHandle()))
        {
            ...
            _getMatrixTrait(getNativeEventSourceHandle(),
                            getNativeSVGProxyHandle(),
                            getHandle(),
                            M2GSVGConstants.EL_SVG, matrix.getComponents(), iUIToolkit);
            return matrix;
        }
        return null;
    }
