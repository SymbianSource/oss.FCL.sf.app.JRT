        ...
        implements Document, M2GConnectionPolicyHandler
{
    ...
    * @see org.w3c.dom.Node#insertBefore()
    ...
    public int requestCompleted(String aUri, byte[] aResourceData)
    {
        ...
        int status = _requestCompleted(
                         getNativeEventSourceHandle(), getNativeSVGProxyHandle(),
                         getHandle(), aUri, aResourceData, iUIToolkit);
    ...
    * @param aSuffixUrl The suffix url from where a document is downloaded.
    ...
    private native static int _createDocument(
        int aEventSourceHandle, int aSvgProxyHandle, String aString, boolean iUIToolkit);

    private native static int _createElementNS(
        int aEventSourceHandle, int aSvgProxyHandle, short aType,
        int aDocumentHandle, boolean iUIToolkit);
    ...
    private native static int _isElementInDOM(
        int aEventSourceHandle, int aSvgProxyHandle, int aDocumentHandle,
        int aElementHandle, boolean iUIToolkit);

    private static native int _requestCompleted(
        int aEventSourceHandle, int aSvgProxyHandle, int aDocumentHandle,
        String aUri, byte[] aResourceData, boolean iUIToolkit);

    private static native void _setViewportHeight(
        int aEventSourceHandle, int aSvgProxyHandle, int aDocumentHandle, int aHeight, boolean iUIToolkit);

    private static native void _setViewportWidth(
        int aEventSourceHandle, int aSvgProxyHandle, int aDocumentHandle, int aWidth, boolean iUIToolkit);
}
