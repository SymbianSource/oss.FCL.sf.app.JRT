...
{
    DEBUG("AMMS::CAMMSSpectatorLocationControl::~CAMMSSpectatorLocationControl");
...
void CAMMSSpectatorLocationControl::PrepareControlL()
{
    ...
    if (!iLocationEffect)
    {
        DEBUG("AMMS::CAMMSSpectatorLocationControl::PrepareControlL");
...
void CAMMSSpectatorLocationControl::DeallocateControl()
{
    if (iLocationEffect)
    {
        DEBUG("AMMS::CAMMSSpectatorLocationControl::DeallocateControl");
