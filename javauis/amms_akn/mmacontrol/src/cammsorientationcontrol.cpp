...
{
    DEBUG("AMMS::CAMMSOrientationControl::~CAMMSOrientationControl");
}
    ...
    TInt aRoll)
{
    ...
    DEBUG_INT3("AMMS::CAMMSOrientationControl::SetOrientationL: %d, %d, %d",
    ...
    TInt aAboveX, TInt aAboveY, TInt aAboveZ)
{
    ...
    DEBUG_INT3("AMMS::CAMMSOrientationControl::SetOrientationL: Front %d, %d, %d",
               aFrontX, aFrontY, aFrontZ);

    DEBUG_INT3("AMMS::CAMMSOrientationControl::SetOrientationL: Above %d, %d, %d",
