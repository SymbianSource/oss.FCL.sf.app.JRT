...
{
    DEBUG("AMMS::CAMMSEMCAudioLocationControl::~CAMMSEMCAudioLocationControl");
...
void CAMMSEMCAudioLocationControl::PrepareControlL()
{
    ...
    {
        DEBUG("AMMS::CAMMSEMCAudioLocationControl::PrepareControlL");
...
void CAMMSEMCAudioLocationControl::DeallocateControl()
{
    if (iMSourceLocationControl)
    {
        DEBUG("AMMS::CAMMSEMCAudioLocationControl::DeallocateControl");
        ...
        {
            // some EMC Error
            DEBUG_INT("AMMS::CAMMSEMCAudioLocationControl::DeallocateControl err = %d",err);
        }
    ...
    TInt& aZ)
{
    ...
    DEBUG_INT3("AMMS::CAMMSEMCAudioLocationControl::SetLocationCartesianL: %d, %d, %d",
               aX, aY, aZ);
    ...
    TInt& aRadius)
{
    ...
    DEBUG_INT3("AMMS::CAMMSEMCAudioLocationControl::SetLocationSphericalL: %d, %d, %d",
