...
TInt CAMMSPanControl::PanL()
{
    ...
    else       // if EMC Pan Control
    {
        ...
        DEBUG("AMMS::CAMMSPanControl::PanL is called for EMC implemented palyer");
...
TInt CAMMSPanControl::SetPanL(TInt aPan)
{
    ...
    else     // EMC Pan Control
    {
        ...
        DEBUG("AMMS::CAMMSPanControl::SetPanL: SetBalance()-- EMC ");
...
void CAMMSPanControl::ConstructL()
{
    ...
    else if (iPlayer->Type() == KMMAEMCAudioPlayer)
    {
        ...
        DEBUG("AMMS::CAMMSPanControl::ConstructL is called for EMC implemented Player");
    }
    else
    {
