 ...
 jint aTempo)  // parameter boundary is checked in Java side.
{
    ...
    CMMAMIDITempoControl* tempoControl =
        JavaUnhand< CMMAMIDITempoControl >(aControlHandle);
    ...
    DEBUG_INT("TempoControl__1setTempo return value %d", returnValue);
 ...
 jint aEventSourceHandle)
{
    ...
    DEBUG_INT("TempoControl__1getTempo return value %d", returnValue);
