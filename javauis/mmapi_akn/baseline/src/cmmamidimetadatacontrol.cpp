...
CMMAMIDIMetaDataControl::CMMAMIDIMetaDataControl(
    CMMAMIDIPlayer* aPlayer)
        : iPlayer(aPlayer)
{
    DEBUG("MMA::CMMAMIDIMetaDataControl constructor called.");
}

TInt CMMAMIDIMetaDataControl::KeyCountL()
{
    DEBUG("MMA: CMMAMIDIMetaDataControl::KeyCountL");
...
{
    DEBUG("MMA: CMMAMIDIMetaDataControl::KeyL");
...
{
    DEBUG("MMA: CMMAMIDIMetaDataControl::KeyValueL");
