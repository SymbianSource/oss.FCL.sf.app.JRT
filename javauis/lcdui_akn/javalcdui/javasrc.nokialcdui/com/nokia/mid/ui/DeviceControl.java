...
public class DeviceControl
{
    ...
    {
        return DeviceControlImpl.getUserInactivityTime();
    }
    /**
    ...
    {
        DeviceControlImpl.resetUserInactivityTime();
    }
    ...
    {
        DeviceControlImpl.setLights(aNum, aLevel);
    }
    ...
    {
        DeviceControlImpl.flashLights(aDuration);
    }
    ...
    {
        Display display = DirectGraphicsInvoker.getDisplay();
        ...
        boolean vibraSupported = display.vibrate(duration);
        if (!vibraSupported)
        {
